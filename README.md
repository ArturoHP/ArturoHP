...
* **Infraestructura y Contenedores:** Gestión de entornos productivos contenerizados utilizando Docker, orquestación de proxies inversos en Nginx y servicios en la nube (GCP, DigitalOcean).
...
| **Cloud & DevOps** | Google Cloud Platform, Docker, Linux (Ubuntu/Debian), Nginx, Git, CI/CD |
